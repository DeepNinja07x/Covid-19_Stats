...
-  Fork this [repository](https://github.com/DeepNinja07x/Covid-19_Stats)
  
-  Clone the forked https://github.com/<Your_Username>/Covid-19_Stats
    > git clone https://github.com/<Your_Username>/Covid-19_Stats.git
...
- Add the upstream (main project's) repo's URL
    ...
    > git remote add upstream https://github.com/DeepNinja07x/Covid-19_Stats.git
