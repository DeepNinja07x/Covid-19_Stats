# ===================================================== Importing libraries ===============================================
import covid                               # pip(3) install covid
import tkinter as tk
import matplotlib.pyplot as plt            # pip(3) install matplotlib
import pandas as pd                        # pip(3) install pandas
...
tk.Label(master, text=e2).grid(row=8)
